  ...
  themeConfig: {
    ...
    socialLinks: [
      { icon: {
          ...
          ariaLabel: 'Main web' },
      { icon: 'github', link: 'https://github.com/manjaro' },
      { icon: {
          ...
          ariaLabel: 'GitLab' },
      { icon: 'x', link: 'https://x.com/ManjaroLinux', ariaLabel: 'X' },
      { icon: 'youtube', link: 'https://youtube.com/@manjaro-linux', ariaLabel: 'Youtube' },
      { icon: 'linkedin', link: 'https://linkedin.com/company/manjaro-linux', ariaLabel: 'LinkedIn' },
    ],
